      ...
      <div className="page-content-wrapper">
        ...
        <div className="achievements-content">
          <div className="achievement-item">
            ...
            <div className="achievement-description">
              <p>
                ...
                AI-powered tools, and client portfolios. Demonstrated strong problem-solving skills and 
                ability to work independently from concept to deployment.
              </p>
              <ul className="achievement-highlights">
                <li>Developed responsive web applications using React.js, HTML, CSS, and JavaScript</li>
                <li>Created AI-powered tools for content generation and optimization</li>
                <li>Built client portfolio websites with modern design and functionality</li>
                <li>Implemented database systems and API integrations</li>
              </ul>
            </div>
          </div>
          ...
          <div className="achievement-item">
            ...
            <div className="achievement-description">
              <p>
                Solved over 60 programming challenges on LeetCode, covering various difficulty levels 
                and problem types. Enhanced algorithmic thinking and data structure implementation skills.
              </p>
              <ul className="achievement-highlights">
                <li>Mastered array manipulation and string processing algorithms</li>
                <li>Solved dynamic programming and graph theory problems</li>
                <li>Improved time and space complexity optimization skills</li>
                <li>Developed strong problem-solving methodology</li>
              </ul>
            </div>
          </div>
          ...
          <div className="achievement-item">
            ...
            <div className="achievement-description">
              <p>
                Successfully solved 30+ programming problems on GeeksForGeeks platform, focusing on 
                data structures, algorithms, and system design concepts.
              </p>
              <ul className="achievement-highlights">
                <li>Strengthened understanding of core data structures</li>
                <li>Practiced advanced algorithm implementations</li>
                <li>Enhanced logical reasoning and coding efficiency</li>
                <li>Built foundation for technical interviews</li>
              </ul>
            </div>
          </div>
          ...
          <div className="achievement-item">
            ...
            <div className="achievement-description">
              <p>
                Led a team in the Smart India Hackathon (SIH), demonstrating strong leadership skills 
                and ability to coordinate team efforts towards innovative solutions.
              </p>
              <ul className="achievement-highlights">
                <li>Coordinated team of 4-6 members effectively</li>
                <li>Managed project timeline and deliverables</li>
                <li>Presented innovative solutions to judges</li>
                <li>Demonstrated problem-solving under pressure</li>
              </ul>
            </div>
          </div>
          ...
          <div className="achievement-item">
            ...
            <div className="achievement-description">
              <p>
                Participated as a team member in the Manipal Hackathon, contributing technical expertise 
                and collaborating effectively with team members to develop innovative solutions.
              </p>
              <ul className="achievement-highlights">
                <li>Contributed to full-stack development tasks</li>
                <li>Collaborated effectively in a competitive environment</li>
                <li>Applied technical skills in real-world problem solving</li>
                <li>Gained experience in rapid prototyping</li>
              </ul>
            </div>
          </div>
        </div>
